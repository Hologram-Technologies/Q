...
// LAZY runtime import (boot-closure law): the vendored transformers view-file is κ-evicted live (G3) —
// the SW rescues it from the κ-store on demand. A static import would 404 for a fresh visitor before
// the SW owns the scope; lazy = the mic affordance simply hides if the ear can't arm (fail-soft).
const TF_URL = "/_shared/voice/vendor/transformers/transformers.js";
let _tfP = null;
const loadTF = () => _tfP || (_tfP = import(TF_URL));
