...
#holo-login .hl-brand{position:fixed;left:50%;transform:translateX(-50%);bottom:max(26px,env(safe-area-inset-bottom));z-index:3;
  pointer-events:none;display:inline-flex;align-items:center;gap:9px;color:var(--ink-dim,rgba(231,237,250,.7));opacity:0;animation:hlm-in .7s ease 1.35s forwards}
#holo-login .hl-brand svg{width:19px;height:19px;flex:0 0 auto;filter:drop-shadow(var(--shadow,0 0 0 transparent))}
#holo-login .hl-brand b{font:700 var(--u,15px)/1 "Segoe UI",system-ui,sans-serif;letter-spacing:.2em;padding-left:.2em;text-shadow:var(--shadow,none)}
...
export function mountManifesto(overlay) {
  ...
  brand.innerHTML = `${GLYPH}<b>HOLOGRAM</b>`;
