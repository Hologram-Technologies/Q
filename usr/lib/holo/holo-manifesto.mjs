...
#holo-login .hl-brand{position:fixed;left:50%;transform:translateX(-50%);bottom:max(26px,env(safe-area-inset-bottom));z-index:3;
  pointer-events:none;display:inline-flex;align-items:center;gap:13px;color:var(--ink,#f4f7fc)}
#holo-login .hl-brand svg{width:40px;height:40px;flex:0 0 auto;filter:drop-shadow(var(--shadow,0 0 0 transparent))}
