...
export async function defaultWordlist() {
  ...
  if (typeof window !== "undefined") {
    // absolute OS-lib path first (it's the one that actually serves) → no 404 noise on the way there; relatives kept as fallback.
    for (const u of ["/usr/lib/holo/words/bip39-english.txt", "/_shared/words/bip39-english.txt", "_shared/words/bip39-english.txt", "pkg/words/bip39-english.txt"]) {
