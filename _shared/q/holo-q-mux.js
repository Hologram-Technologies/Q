...
export const TASKS = [
  ...
  // Deep reasoning — a 9B THINKING brain (Qwen3.5). NOT a silent default: the device-tier gate
  // (holo-q-think-tier.mjs) routes the 9B only to capable WebGPU hardware; weak/mobile fall to respond.
  { id: "think",          label: "Think",         job: "Deep reasoning",       pipeline: "text-generation",   need: "generative", maxParams: "9B",   pinned: true },
...
export const PINNED = {
  ...
  // think — the precompiled 9B reasoner (DavidAU Qwen3.5-9B THINKING, imatrix Q4_K_M, arch qwen35). The OS's
  // pinned thinking brain; the device-tier gate (holo-q-think-tier) decides whether THIS device loads it or
  // routes to `respond`. No `upgrade` tier — the 9B IS the top tier; weak/mobile fall back, never auto-load it.
  think:   { faculty: "think",   instant: { id: "qwen3.5-9b-thinking", kappa: "2c9265545555b864438c49df81b72e4ae9221f32f0b4f8ab4ceaa846ea38d94f", bytesMB: 5627.1 } },
