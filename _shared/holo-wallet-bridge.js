...
//
// Usage (from any app):
//   import { requestSend, requestSignMessage } from "./holo-wallet-bridge.js";
...
export const seam = {
  ...
  // Holo Pay HTLC settlement — reads (configured?, swap exists?) are quick + ungated; fund/claim/refund move value (gated).
  htlcConfigured: (a = {}) => requestSignature({ kind: "htlcConfigured", chain: a.chain }, { timeoutMs: 15000 }),
  htlcSwapExists: (a = {}) => requestSignature({ kind: "htlcSwapExists", hashlock: a.hashlock, chain: a.chain }, { timeoutMs: 20000 }),
  htlcFund: (a = {}, o = {}) => requestSignature({ kind: "htlcFund", chain: a.chain, amount: a.amount, token: a.token, hashlock: a.hashlock, timeout: a.timeout, delegation: o.delegation }, { timeoutMs: 180000 }),
  htlcClaim: (a = {}, o = {}) => requestSignature({ kind: "htlcClaim", chain: a.chain, hashlock: a.hashlock, preimage: a.preimage, delegation: o.delegation }, { timeoutMs: 180000 }),
  htlcRefund: (a = {}, o = {}) => requestSignature({ kind: "htlcRefund", chain: a.chain, hashlock: a.hashlock, delegation: o.delegation }, { timeoutMs: 180000 }),
};

// Convenience wrappers (parity with requestSend/requestSignMessage): let any app drive Holo Pay's on-chain leg.
export const requestHtlcFund = (chain, { hashlock, timeout, token, amount } = {}) => requestSignature({ kind: "htlcFund", chain, hashlock, timeout, token, amount }, { timeoutMs: 180000 });
export const requestHtlcClaim = (chain, { hashlock, preimage } = {}) => requestSignature({ kind: "htlcClaim", chain, hashlock, preimage }, { timeoutMs: 180000 });
export const requestHtlcRefund = (chain, { hashlock } = {}) => requestSignature({ kind: "htlcRefund", chain, hashlock }, { timeoutMs: 180000 });
