...
const AUTHORITY = new Set(["delegation.issue", "delegation.attenuate", "space.membership", "space.epoch", "terms.grantSensitive", "everything.open", "capability.grant",
  // Open Banking AIS consent acts — authority-class, NOT value: a fresh same-kind step-up may stand within the
  // window, which is exactly what lets a batch of due reconfirms clear in ONE biometric. (Reads never step up.)
  "bank.consent.grant", "bank.consent.reconfirm", "bank.consent.revoke"]);
